...
class OpenDocs_Importer_Admin {
	...
	public function admin_menu() {
		...
		$this->rejected_menu_suffix = add_submenu_page( 'opendocs_import', 'Rejected Items', 'Rejected Items', 'manage_options', 'odocs_rejected', array(
			$this,
			'admin_odocs_rejected_callback'
		) );
                        ...
                        <div class="rejected-list items-list">
                            <div class="list-header">
                                <div class="select-all">
                                    <a href="#" id="delete-all" name="delete-all" data-type="delete" class="check-all">Delete
                                        All</a>
                                </div>
						...
						<?php foreach ( $rejectedItemsInfo as $itemID => $rejectedItemInfo ) : ?>
                            <div class="item-row">
                                <div class="row item-delete">
                                    <p>
                                        <a href="#" id="delete<?php echo $itemID; ?>" name="delete"
                                           data-action="rejectedItem" data-id="<?php echo $itemID; ?>" class="delete">Delete</a>
                                    </p>
                                </div>
                                ...
                                <div class="row coll-date">
                                    <p>
                                        <a href="<?php echo $rejectedItemInfo['handle']; ?>" target="_blank">OpenDocs
                                            Link</a>
                                    </p>
                                </div>
                            </div>
            ...
            <div class="imports-list items-list edit-list">
				<?php if ( $cronImportList ) : ?>
					...
					<?php foreach ( $cronImportList as $import ) :
                        ...
                        <div class="item-row">
                            <div class="item-delete"><a href="#" data-id="<?php echo $import->id; ?>"
                                                        data-coll-id="<?php echo $import->collectionID; ?>"
                                                        data-action="deleteCRONJob">Delete</a></div>
                            <div class="row coll-name"><a href="#" class="edit-job"
                                                          data-coll-id="<?php echo $import->collectionID; ?>"
                                                          data-count="<?php echo $itemsInCollection; ?>"
                                                          data-postType="<?php echo $importOptions->postType; ?>"><?php echo $jobName; ?></a>
                            </div>
                            <div class="row coll-info"><a href="#" class="imported-items"
                                                          data-cronid="<?php echo $import->id; ?>">View</a></div>
                            <div class="row coll-info"><a href="#" class="existing-items"
                                                          data-cronid="<?php echo $import->id; ?>">View</a></div>
                            <div class="row coll-info coll-notify"><?php echo $notifyEmail; ?></div>
                            <div class="row coll-info import-post"
                                 data-status="<?php echo $importOptions->postStatus; ?>"><?php echo ucfirst( $postType ); ?></div>
                        ...
                        <div id="existing-items-dialog-<?php echo $import->id; ?>" class="existing-items-dialog"
                             title="Rejected Items">
                            <ul>
								<?php if ( $rejectedItemsList ) : ?>
									<?php foreach ( $rejectedItemsList as $rejectedItem ) : ?>
                                        <li><a href="<?php echo $rejectedItem['handle']; ?>"
                                               target="_blank"><?php echo $rejectedItem['name']; ?></a></li>
									<?php endforeach; ?>
								<?php else : ?>
                                    <h4>
